...
def process_log_data(spark, input_data, output_data):
    ...
    songplays_table = df.join(song_df, df.song == song_df.title, df.length == song_df.duration, df.artist == song_df.artist_name, how='inner') \
    ...
    songplays_table = songplays_table.join(time_table, songplays_table.start_time == time_table.start_time, how="inner") \
                        .select("songplay_id", songplays_table.start_time, "user_id", "level", "song_id", \
                                "artist_id", "session_id", "location", "user_agent", "year", "month").dropDuplicates()
